Currently started a Path of Professional Machine Learning Engineer in Google Cloud (https://www.cloudskillsboost.google/paths/17/)
...
3. Started 03 Developing Applications with Google Cloud: Foundations, 2% done
4. Working on Pluralsight course on the same topic (Associate Cloud Engineer)
